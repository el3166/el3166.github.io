...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://1rcx5y4w6e.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['body', 'x-api-key', 'q'], ['body']);
    ...
    apigClient.folderObjectPut = function (params, body, additionalParams) {
        ...
        apiGateway.core.utils.assertParametersDefined(params, ['object', 'folder', 'Content-Type', 'label', 'x-api-key'], ['body']);
        ...
        var folderObjectPutRequest = {
            ...
            headers: apiGateway.core.utils.parseParametersToObject(params, ['Content-Type', 'label', 'x-api-key']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
